// Fiação = VCC-3.3v; GND-GND; SCL-D22; SDA-D21
...
String SendHTML(float temperatura,float umididade,float pressao,float altitude){
  String ptr = "<!DOCTYPE html>";
  ptr +="<html>";
  ptr +="<head>";
  ptr +="<title>Clima</title>";
  ...
  ptr +=".umidade .reading{color: #3B97D3;}";
  ptr +=".pressao .reading{color: #26B99A;}";
  ...
  ptr +="</div>";
  ptr +="<div class='side-by-side text'>Press&atilde;o</div>";
  ptr +="<div class='side-by-side reading'>";
  ptr +=(int)pressao;
